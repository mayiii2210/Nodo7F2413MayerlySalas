...
const HP1 = document.querySelector(".pokemon-1__hp");
const Name1 = document.querySelector(".pokemon-1__name");
const Attack1 = document.querySelector(".pokemon-1__attack");
const Defense1 = document.querySelector(".pokemon-1__defense");
const Type1 = document.querySelector(".pokemon-1__type");


// Selectores para el Pokemon 2
const HP2 = document.querySelector(".pokemon-2__hp");
const Name2 = document.querySelector(".pokemon-2__name");
const Attack2 = document.querySelector(".pokemon-2__attack");
const Defense2 = document.querySelector(".pokemon-2__defense");
const Type2 = document.querySelector(".pokemon-2__type");
...
const pokeID1 = getRandomNumber(1, 900); 
const pokeID2 = getRandomNumber(1, 900);
